...
origFol = "./distAttrDataStoreResults1000Images_May13/ORIG/"
FGSM2Fol = "./distAttrDataStoreResults1000Images_May13/FGSM2/"
FGSM5Fol = "./distAttrDataStoreResults1000Images_May13/FGSM5/"
CWFol = "./distAttrDataStoreResults1000Images_May13/CW/"
DFFol = "./distAttrDataStoreResults1000Images_May13/DF/"
PGDFol = "./distAttrDataStoreResults1000Images_May13/PGDESP/"
...
for i in range(len(files)):
    ...
    for j in range(sameFlag.size):
        if sameFlag[j] == 1 and i == 0 and j < 1000: #this is the original
            allPoints[i] = np.append(allPoints[i],flipProb[powerIdx][j])
            #allPoints[i] = np.append(allPoints[i],crossentropy[powerIdx][j])
        elif sameFlag[j] == 0 and i != 0 and j < 1000:
            allPoints[i] = np.append(allPoints[i],flipProb[powerIdx][j])
            #allPoints[i] = np.append(allPoints[i],crossentropy[powerIdx][j])
